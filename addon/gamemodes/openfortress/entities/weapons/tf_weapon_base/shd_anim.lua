...
function SWEP:SetWeaponHoldType(t)
	...
	if t == "PISTOL_MERCENARY" and v:GetPlayerClass() == "mercenary" then
	...
	elseif t == "PISTOL_MERCENARY" and v:GetPlayerClass() != "mercenary" then
		self.ActivityTranslate[ACT_MP_STAND_IDLE] 				= _G["ACT_MP_STAND_SECONDARY"]
		self.ActivityTranslate[ ACT_MP_RUN ]						= _G["ACT_MP_RUN_SECONDARY"] 
		self.ActivityTranslate[ ACT_MP_CROUCH_IDLE ]				= _G["ACT_MP_CROUCH_SECONDARY"]
		self.ActivityTranslate[ ACT_MP_CROUCHWALK ]					= _G["ACT_MP_CROUCHWALK_SECONDARY"]
		self.ActivityTranslate[ ACT_MP_SWIM ]						= _G["ACT_MP_SWIM_SECONDARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_STAND]		 				= _G["ACT_MP_RELOAD_STAND_SECONDARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_CROUCH]		 			= _G["ACT_MP_RELOAD_CROUCH_SECONDARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_SWIM]		 				= _G["ACT_MP_RELOAD_SWIM_SECONDARY"]
		self.ActivityTranslate[ACT_MP_ATTACK_STAND_PRIMARYFIRE] 		= _G["ACT_MP_ATTACK_STAND_SECONDARY"]
		self.ActivityTranslate[ACT_MP_ATTACK_CROUCH_PRIMARYFIRE]		= _G["ACT_MP_ATTACK_CROUCH_SECONDARY"]
		self.ActivityTranslate[ACT_MP_ATTACK_SWIM_PRIMARYFIRE]			= _G["ACT_MP_ATTACK_SWIM_SECONDARY"]
	end
