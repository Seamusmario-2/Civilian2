...
function SWEP:SetWeaponHoldType(t)
	...
	if t == "PISTOL_MERCENARY" then
		self.ActivityTranslate[ACT_MP_STAND_IDLE] 				= _G["ACT_MERC_STAND_PISTOL_MERCENARY"]
		self.ActivityTranslate[ ACT_MP_RUN ]						= _G["ACT_MERC_RUN_PISTOL_MERCENARY"]
		self.ActivityTranslate[ ACT_MP_CROUCH_IDLE ]				= _G["ACT_MERC_CROUCH_PISTOL_MERCENARY"]
		self.ActivityTranslate[ ACT_MP_CROUCHWALK ]					= _G["ACT_MERC_CROUCHWALK_PISTOL_MERCENARY"]
		self.ActivityTranslate[ ACT_MP_SWIM ]						= _G["ACT_MERC_SWIM_PISTOL_MERCENARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_STAND]		 				= _G["ACT_MERC_RELOAD_STAND_PISTOL_MERCENARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_CROUCH]		 			= _G["ACT_MERC_RELOAD_CROUCH_PISTOL_MERCENARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_SWIM]		 				= _G["ACT_MERC_RELOAD_SWIM_PISTOL_MERCENARY"]
	end
	if t == "SMG_MERCENARY" then
		self.ActivityTranslate[ACT_MP_STAND_IDLE] 				= _G["ACT_MERC_STAND_SMG_MERCENARY"]
		self.ActivityTranslate[ ACT_MP_RUN ]						= _G["ACT_MERC_RUN_SMG_MERCENARY"]
		self.ActivityTranslate[ ACT_MP_CROUCH_IDLE ]				= _G["ACT_MERC_CROUCH_SMG_MERCENARY"]
		self.ActivityTranslate[ ACT_MP_CROUCHWALK ]					= _G["ACT_MERC_CROUCHWALK_SMG_MERCENARY"]
		self.ActivityTranslate[ ACT_MP_SWIM ]						= _G["ACT_MERC_SWIM_SMG_MERCENARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_STAND]		 				= _G["ACT_MERC_RELOAD_STAND_SMG_MERCENARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_CROUCH]		 			= _G["ACT_MERC_RELOAD_CROUCH_SMG_MERCENARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_SWIM]		 				= _G["ACT_MERC_RELOAD_SWIM_SMG_MERCENARY"]
	end
	if t == "SUPER_SHOTGUN" and v:GetPlayerClass() == "mercenary" then
		self.ActivityTranslate[ACT_MP_STAND_IDLE] 				= _G["ACT_MERC_STAND_SUPERSHOTGUN"]
		self.ActivityTranslate[ ACT_MP_RUN ]						= _G["ACT_MERC_RUN_SUPERSHOTGUN"] 
		self.ActivityTranslate[ ACT_MP_CROUCH_IDLE ]				= _G["ACT_MERC_CROUCH_SUPERSHOTGUN"]
		self.ActivityTranslate[ ACT_MP_CROUCHWALK ]					= _G["ACT_MERC_CROUCHWALK_SUPERSHOTGUN"]
		self.ActivityTranslate[ ACT_MP_SWIM ]						= _G["ACT_MERC_SWIM_PISTOL_MERCENARY"]
		self.ActivityTranslate[ACT_MP_RELOAD_STAND]		 				= _G["ACT_MERC_RELOAD_STAND_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_RELOAD_CROUCH]		 			= _G["ACT_MERC_RELOAD_CROUCH_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_RELOAD_SWIM]		 				= _G["ACT_MERC_RELOAD_SWIM_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_ATTACK_STAND_PRIMARYFIRE] 		= _G["ACT_MP_ATTACK_STAND_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_ATTACK_CROUCH_PRIMARYFIRE]		= _G["ACT_MP_ATTACK_CROUCH_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_ATTACK_SWIM_PRIMARYFIRE]			= _G["ACT_MP_ATTACK_SWIM_SUPERSHOTGUN"]
		
		self.ActivityTranslate[ACT_MP_ATTACK_STAND_SECONDARYFIRE] 		= _G["ACT_MP_ATTACK_STAND_SUPERSHOTGUN_SECONDARY"]
		self.ActivityTranslate[ACT_MP_ATTACK_CROUCH_SECONDARYFIRE]		= _G["ACT_MP_ATTACK_CROUCH_SUPERSHOTGUN_SECONDARY"]
		self.ActivityTranslate[ACT_MP_ATTACK_SWIM_SECONDARYFIRE]		= _G["ACT_MP_ATTACK_SWIM_SUPERSHOTGUN_SECONDARY"]
		
		self.ActivityTranslate[ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED] 	= _G["ACT_MP_ATTACK_STAND_SUPERSHOTGUN_DEPLOYED"]
		self.ActivityTranslate[ACT_MP_ATTACK_CROUCH_PRIMARY_DEPLOYED] 	= _G["ACT_MP_ATTACK_CROUCH_SUPERSHOTGUN_DEPLOYED"]
		self.ActivityTranslate[ACT_MP_ATTACK_SWIM_PRIMARY_DEPLOYED]= _G["ACT_MP_ATTACK_SWIM_SUPERSHOTGUN_DEPLOYED"]
	elseif t == "SUPER_SHOTGUN" and v:GetPlayerClass() != "mercenary" then
		self.ActivityTranslate[ACT_MP_STAND_IDLE] 				= _G["ACT_MERC_STAND_SUPERSHOTGUN"]
		self.ActivityTranslate[ ACT_MP_RUN ]						= _G["ACT_MERC_RUN_SUPERSHOTGUN"] 
		self.ActivityTranslate[ ACT_MP_CROUCH_IDLE ]				= _G["ACT_MERC_CROUCH_SUPERSHOTGUN"]
		self.ActivityTranslate[ ACT_MP_CROUCHWALK ]					= _G["ACT_MERC_CROUCHWALK_SUPERSHOTGUN"]
		...
		self.ActivityTranslate[ACT_MP_RELOAD_CROUCH]		 			= _G["ACT_MERC_RELOAD_CROUCH_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_RELOAD_SWIM]		 				= _G["ACT_MERC_RELOAD_SWIM_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_ATTACK_STAND_PRIMARYFIRE] 		= _G["ACT_MERC_ATTACK_STAND_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_ATTACK_CROUCH_PRIMARYFIRE]		= _G["ACT_MERC_ATTACK_CROUCH_SUPERSHOTGUN"]
		self.ActivityTranslate[ACT_MP_ATTACK_SWIM_PRIMARYFIRE]			= _G["ACT_MERC_ATTACK_SWIM_SUPERSHOTGUN"]
		
		self.ActivityTranslate[ACT_MP_ATTACK_STAND_SECONDARYFIRE] 		= _G["ACT_MERC_ATTACK_STAND_SUPERSHOTGUN_SECONDARY"]
		self.ActivityTranslate[ACT_MP_ATTACK_CROUCH_SECONDARYFIRE]		= _G["ACT_MERC_ATTACK_CROUCH_SUPERSHOTGUN_SECONDARY"]
		self.ActivityTranslate[ACT_MP_ATTACK_SWIM_SECONDARYFIRE]		= _G["ACT_MERC_ATTACK_SWIM_SUPERSHOTGUN_SECONDARY"]
		
		self.ActivityTranslate[ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED] 	= _G["ACT_MERC_ATTACK_STAND_SUPERSHOTGUN_DEPLOYED"]
		self.ActivityTranslate[ACT_MP_ATTACK_CROUCH_PRIMARY_DEPLOYED] 	= _G["ACT_MERC_ATTACK_CROUCH_SUPERSHOTGUN_DEPLOYED"]
		self.ActivityTranslate[ACT_MP_ATTACK_SWIM_PRIMARY_DEPLOYED or 0]= _G["ACT_MERC_ATTACK_SWIM_SUPERSHOTGUN_DEPLOYED"]	
	end
